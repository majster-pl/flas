...
UBUNTU_TRANSLATION_DOMAIN="flas.majster-pl"
...
aptest.commands = bash $$PWD/flas/tests/autopilot/run
aptest.depends  = sub-flas

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/flas/tests/unit 
unittest.depends  = sub-flas
